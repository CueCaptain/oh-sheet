            ...
            <Flex direction={'column'}>
                ...
                <Flex align={'center'} mb={'sm'}>
                    <Input 
                        ...
                        onChange={(e: any) => {setStageTimerMessage(e.target.value)}}
                        mr={'lg'}
                    ...
                    { messageData.stageTimerMessage !== '' ? 
                        ...
                        : 
                        <ActionIcon size={'lg'} onClick={() => server.setMessageData('stageTimerMessage', stageTimerMessage)}>
                            <IoArrowForward/>
                        </ActionIcon>
                    }                
                </Flex>
                ...
                <Flex align={'center'}>
                    ...
                    { messageData.operatorMessage !== '' ? 
                        ...
                        : 
                        <ActionIcon size={'lg'} onClick={() => server.setMessageData('operatorMessage', operatorMessage)}>
                            <IoArrowForward/>
                        </ActionIcon>
                    }
                </Flex>
