...
export default function Cue (props: ICueProps) {
    ...
    const extraStyles = props.bg !== 'dark.6' ? {
        overflow: 'auto', 
        borderRadius: '1rem', 
        flexGrow: 1,
    ...
    return (
        <Flex direction={'column'} h={'100%'} p={1} style={opacityStyle}>
            <Box h={'32px'} bg={props.bg} mb={'xs'} style={{overflow: 'hidden', borderRadius: '1rem'}}>
            ...
            <Box
                ...
                style={extraStyles}
            >
                <Box miw={'300px'} top={0} bg={'dark.6'} style={{position: 'sticky', borderBottom: 'calc(0.0625rem* var(--mantine-scale)) solid var(--mantine-color-dark-4)'}}>
